...
const submit = () => {
    form.post(route('administration.store'), {
        forceFormData: true,
    });
};
</script>
...
<template>
    <Head title="Create Administration Unit" />
            ...
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-500">
                        Register a new university administration unit or faculty profile.
                    </p>
                </div>
            </div>
        </template>
                        ...
                        <section>
                            ...
                            <div class="grid gap-8 grid-cols-1">
                                <div class="space-y-2">
                                    ...
                                    <TextInput id="title" v-model="form.title" class="w-full h-16 !text-lg !rounded-2xl !bg-gray-50/50 !border-gray-100 focus:!bg-white shadow-sm" placeholder="e.g. Faculty of Engineering" required />
                                ...
                                <div class="space-y-2">
                                    ...
                                    <textarea 
                                        ...
                                        placeholder="Describe the main function of this unit..."
                                    ></textarea>
                                ...
                                <div class="flex-1 w-full space-y-6">
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <div class="space-y-2">
                                            ...
                                            <TextInput id="director_name" v-model="form.director_name" class="w-full h-14 !bg-gray-50/50 !border-gray-100" placeholder="e.g. Dr. Ahmed Ali" required />
                                        ...
                                        <div class="space-y-2">
                                            ...
                                            <TextInput id="director_title" v-model="form.director_title" class="w-full h-14 !bg-gray-50/50 !border-gray-100" placeholder="e.g. Dean of Faculty" required />
                                            <InputError :message="form.errors.director_title" />
                                        </div>
                                    </div>

                                    <div class="p-6 rounded-3xl bg-primary/5 border border-primary/10">
                                         <InputLabel for="access_password" value="Internal Security Password (Optional)" class="!text-[11px] !font-black !uppercase !tracking-widest !text-primary/60" />
                                         <TextInput id="access_password" type="password" v-model="form.access_password" class="w-full h-14 !bg-white !border-primary/20 mt-2 focus:!ring-primary/20" placeholder="••••••••" />
                                         <p class="text-[10px] text-primary/40 mt-2 italic font-medium">Used for future controlled access to departmental records.</p>
