        ...
        <div class="py-8">
            <div class="w-full">
                ...
                >
                    ...
                    <h3 class="mt-4 text-sm font-medium text-gray-900">No levels found</h3>
                    <p class="mt-1 text-sm text-gray-500">
                        Get started by adding a new floor or level.
                    </p>
                    <div class="mt-6">
                         <Link
                            v-if="can('level-create')"
                    ...
                    <table class="min-w-full divide-y divide-gray-200 text-sm">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th class="px-6 py-3 text-left font-semibold text-gray-900">Number</th>
                        ...
                        <tbody class="divide-y divide-gray-200 bg-white">
                            <tr v-for="level in filteredLevels" :key="level.id" class="transition-colors hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 text-right">
                                    <div class="flex justify-end gap-3">
                                        ...
                                        <button
                                            ...
                                            @click="() => { if(confirm('Are you sure you want to delete this level?')) deleteLevel(level.id) }"
                                            title="Delete"
                                        >
