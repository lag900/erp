                ...
                >
                    <div class="border-b border-gray-100 bg-gray-50 px-6 py-4 flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-sm text-gray-500">Update the premise details below.</p>
                        </div>
                        <DangerButton
                            v-if="can('location-delete')"
                            type="button"
                            class="text-xs"
                            @click="() => { if(confirm('Are you sure you want to delete this location?')) $inertia.delete(route('locations.destroy', location.id)) }"
                        >
