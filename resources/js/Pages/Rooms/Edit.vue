            ...
            <div class="flex flex-wrap items-center justify-between gap-3">
                ...
                <div class="flex flex-wrap gap-2">
                    ...
                    <DangerButton
                        ...
                        type="button"
                        @click="$inertia.delete(route('rooms.destroy', room.id))"
                    >
                        Delete
                    </DangerButton>
                </div>
        ...
        <div class="py-6">
            <div class="mx-auto max-w-3xl sm:px-6 lg:px-8">
                <form
                    ...
                    @submit.prevent="form.put(route('rooms.update', room.id))"
                >
                    ...
                    <div class="mt-8 flex justify-end">
                        <PrimaryButton v-if="can('room-edit')" :disabled="form.processing">
                            Save Changes
                        </PrimaryButton>
                    </div>
                </form>
